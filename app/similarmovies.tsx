...
const SimilarMoviesPage = () => {
  ...
  const { id: paramId, type: paramType, name: paramName } = useLocalSearchParams();
  const title = paramName as string;
  const movieId = Number(paramId);
  const mediaType = paramType as 'movie' | 'tv';
